...
missionNamespace setVariable ['ca_wavecooldown',5, true]; // Seconds between each wave plus 60(window to respawn in)
...
missionNamespace setVariable ["f_var_JIP_RespawnMenu",true, true]; // Do respawning players get the JIP menu?
missionNamespace setVariable ["f_var_JIP_RemoveCorpse",true, true]; // Remove the old corpse of respawning players?
